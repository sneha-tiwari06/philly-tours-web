    ...
    <div className="modal-dialog modal-dialog-centered" role="document">
        <div className="modal-content">
            <div className="modal-body">
                <div className="modal-logo"><img src="./images/logo.svg" alt="Jainco Group" /></div>
                <h6 className="modal-title"><small>Please fill in your details below and we will get in touch with you shortly.</small></h6>
                <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                <div className="formContainer pr-0">
                    <div className="form">
                        <form className="form-container" id="modal_form" method="post">
                            <p className="statusm mb-0" style={{color: "#ff392d"}}></p>
                            <div className="form-row">
                                ...
                                <div className="col-md-12 form-group">
                                    ...
                                    <input type="tel" className="form-control" name="mmobile" id="mmobile" />
                                </div>
                                <div className="col-md-12 form-group">
                                    <label for="email">Email<sup className="text-danger">*</sup></label>
                                    <input type="email" className="form-control" name="memail" id="memail" />
                                </div>
                                <div className="col-md-12 formFooter readmore mt-3">
                                    <input type="hidden" name="modal_action" value="active" />
                                    <button type="submit" className="button" id="mbtnpopup">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
